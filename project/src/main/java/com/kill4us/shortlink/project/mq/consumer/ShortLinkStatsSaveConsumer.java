package com.kill4us.shortlink.project.mq.consumer;
...
import com.kill4us.shortlink.project.dao.entity.LinkAccessLogsDO;
import com.kill4us.shortlink.project.dao.entity.LinkAccessStatsDO;
import com.kill4us.shortlink.project.dao.entity.LinkBrowserStatsDO;
...
import com.kill4us.shortlink.project.dao.mapper.LinkDeviceStatsMapper;
...
import com.kill4us.shortlink.project.dto.biz.ShortLinkStatsRecordDTO;
import com.kill4us.shortlink.project.mq.idempotent.MessageQueueIdempotentHandler;
...
public class ShortLinkStatsSaveConsumer implements StreamListener<String, MapRecord<String, String, String>> {
    ...
    private final LinkLocalStatsMapper linkLocaleStatsMapper;
    ...
    public void actualSaveShortLinkStats(String fullShortUrl, String gid, ShortLinkStatsRecordDTO statsRecord) {
        ...
        try {
            ...
            String localeResultStr = HttpUtil.get(APAM_URL, localeParamMap);
