...
import com.kill4us.shortlink.project.common.convention.exception.ClientException;
...
import com.kill4us.shortlink.project.config.GotoDomainWhiteListConfiguration;
...
public class ShortLinkServiceImpl extends ServiceImpl<ShortLinkMapper, ShortLinkDO> implements ShortLinkService {
    ...
    private String generateSuffix(ShortLinkCreateReqDTO requestParam) {
        ...
        while (true) {
            ...
            if (!shortLinkCreateCachePenetrationBloomFilter.contains(defaultDomain + "/" + shortUri)) {
                break;
            }
            customGenerateCount++;
        }
        ...
        if (Objects.equals(hasShortLinkDO.getGid(), requestParam.getGid())) {
            ...
            try {
                ...
                LinkLocalStatsDO linkLocaleStatsDO = LinkLocalStatsDO.builder()
                        .gid(requestParam.getGid())
                        .build();
                linkLocalStatsMapper.update(linkLocaleStatsDO, linkLocaleStatsUpdateWrapper);
    ...
    private ShortLinkStatsRecordDTO buildLinkStatsRecordAndSetUser(String fullShortUrl, ServletRequest request, ServletResponse response) {
        ...
        String os = LinkUtil.getUserOS(((HttpServletRequest) request));
    ...
    public void shortLinkStats(String fullShortUrl, String gid, ShortLinkStatsRecordDTO statsRecord) {
        ...
        try {
            ...
            requestLocaleMap.put("ip", statsRecord.getRemoteAddr());
